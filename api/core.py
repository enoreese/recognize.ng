...
def get_pg_url(file = "creds.ini"):
    ...
    try:
        ...
        print(
            "Failed to retrieve postgres url. Check if {file} exists in the top directory and whether it follows the correct format. INGORE this message if you are not using {file} to store your credentials."
        )
        return None
